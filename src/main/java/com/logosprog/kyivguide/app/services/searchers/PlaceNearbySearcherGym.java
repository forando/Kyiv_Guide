...
/**
 * A class that queries google.places API for gym objects.<br>
 *
 * Created by forando on 24.12.14.
 */
public class PlaceNearbySearcherGym extends PlaceNearbySearcher {
    ...
    public PlaceNearbySearcherGym(double latitude, double longitude) {
